...
Yes.  
For a first playthrough, I would suggest the Fashionista Profile its Bug Fixes updated Graphics and  or the unofficial patch profile. It is just bugfixes and graphic updates, the other profiles are harder and I would only suggest them for 2nd playthroughs.
