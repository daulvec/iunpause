...
[Next: Installation](/Fashionista/Installation/InstallingTheList.html){: .btn .btn-purple }
{: .text-center }
...
1. Sign into GOG and go to the [Account page](https://www.gog.com/en/account)
2. Use the Search bar to find the game (search for ```Bloodlines```) then click on the game.
